            ...
            <table class="w-full">
                <thead class="bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-xs font-bold text-gray-700 dark:text-gray-200 text-center">Total Documents</th>
                        <th class="px-6 py-3 text-xs font-bold text-gray-700 dark:text-gray-200 text-center">Average Duration</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    <template v-if="documentStatistics.length > 0">
                        <template v-for="docStat in documentStatistics" :key="`doc-${docStat.documentType}`">
...
defineProps<{
    ...
    expandedDocumentType: string | null;
    getDocumentsForType: (type: string) => any[];
    formatHours: (hours: number) => string;
    calculateProcessingTime: (doc: any) => string;
    getTimeLeftStyles: (doc: any) => object;
    getTimeLeftText: (doc: any) => string;
    toggleDocumentTypeExpanded: (type: string) => void;
}>();
</script>
