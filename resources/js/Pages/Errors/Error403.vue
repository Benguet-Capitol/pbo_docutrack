<template>
  <div class="bg-gradient-to-br from-amber-500 to-amber-600 min-h-screen flex items-center justify-center p-4">
    <div class="animate-fade-in max-w-md w-full">
      <div class="bg-white rounded-lg shadow-2xl p-8 text-center">
        ...
        <div class="space-y-3 animate-fade-in" style="animation-delay: 0.3s;">
          <Link href="/dashboard" class="block w-full bg-gradient-to-r from-amber-600 to-amber-700 text-white font-semibold py-3 rounded-lg hover:shadow-lg transform hover:scale-105 transition-all duration-300">
            Go to Dashboard
          </Link>
          <Link href="/" class="block w-full border-2 border-amber-600 text-amber-600 font-semibold py-3 rounded-lg hover:bg-amber-50 transition-colors duration-300">
            Back to Home
          </Link>
        </div>
