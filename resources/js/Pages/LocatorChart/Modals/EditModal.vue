<template>
    <Teleport to="body" v-if="show && meetingToEdit">
            ...
            <div class="relative w-full max-w-md mx-4 bg-white rounded-lg shadow-lg dark:bg-gray-800 animate-scaleInUp">
                ...
                <div class="px-6 py-4 overflow-y-auto" style="max-height: calc(90vh - 200px);">
                    <div class="grid gap-4">
                        ...
                        <!-- Time Field -->
                        <div class="space-y-2">
                            <label for="edit_meeting_time" class="block text-xs font-medium text-gray-700 dark:text-gray-300">Time <span class="text-red-600">*</span></label>
                            <div class="relative flex items-center">
                                ...
                                <input
                                    ...
                                    :class="[formErrors.time ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-blue-500']"
                                />
                            </div>
                        ...
                        <!-- Particulars Field -->
                        <div class="space-y-2">
                            <label for="edit_meeting_particulars" class="block text-xs font-medium text-gray-700 dark:text-gray-300">Particulars <span class="text-red-600">*</span></label>
                            <div class="relative flex items-start">
                                ...
                                <textarea
                                    ...
                                    :class="[formErrors.particulars ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-blue-500']"
                                ></textarea>
                            </div>
...
export interface NoticeOfMeetingRecord {
    id: number;
    time: string;
    particulars: string;
}
...
defineProps<{
    show: boolean;
    meetingToEdit: NoticeOfMeetingRecord | null;
    employeeName: string;
    dateDisplay: string;
