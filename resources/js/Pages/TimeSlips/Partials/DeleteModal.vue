                ...
                <div class="relative w-full max-w-md mx-4 bg-white rounded-lg shadow-lg dark:bg-gray-800 animate-scaleInUp">
                    ...
                    <div class="px-6 py-6">
                        <p class="text-sm text-gray-600 dark:text-gray-300 mb-2">
                            Are you sure you want to delete this time slip?
                        </p>
                        ...
                        <p class="text-sm font-medium text-gray-900 dark:text-white mb-4">
                            Employee: <span class="font-bold text-red-600">{{ recordToDelete?.requesting_employee?.name }}</span>
                        </p>
                        <p class="text-sm font-medium text-gray-900 dark:text-white mb-4">
                            Date: <span class="font-bold text-red-600">{{ formatDate(recordToDelete?.date) }}</span>
                        </p>
